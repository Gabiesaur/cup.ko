            ...
            <div className="relative z-10 w-full min-h-dvh lg:h-full max-w-[1440px] flex flex-col justify-center lg:pl-10 py-12 lg:py-0">
                ...
                <div className="w-full lg:w-[50%] flex flex-col items-center lg:items-start z-20 lg:pl-20 shrink-0">
                    <h1
                        ...
                        className="text-center lg:text-left text-5xl md:text-6xl lg:text-7xl font-bold text-[#CE828E] leading-[1.1] italic mb-4"
                    >
                        Thank You!
                    </h1>
                    ...
                    <p
                        ...
                        className="text-center lg:text-left text-2xl md:text-3xl text-[#CE828E] mb-8 px-4 lg:px-0"
                    >
                        Your order has been received.<br />
                        We'll prepare your treats with love!
                    </p>

                    <div className="flex flex-col sm:flex-row gap-4 w-full justify-center lg:justify-start mt-5 px-4 lg:px-0">
                        <button
                            onClick={() => navigate('/')}
                            style={{ fontFamily: "'Patrick Hand', cursive" }}
